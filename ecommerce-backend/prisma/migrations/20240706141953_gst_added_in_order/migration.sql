/*
  ...
  - Added the required column `gstPrice` to the `Order` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "Order" ADD COLUMN     "gstPrice" DOUBLE PRECISION NOT NULL,
ALTER COLUMN "id" SET DEFAULT concat('order_', replace(cast(gen_random_uuid() as text), '-', '')),
